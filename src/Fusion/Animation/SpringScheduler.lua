...
local function updateAllSprings()
	...
	for spring in pairs(activeSprings) do
		local lastSchedule: number? = spring._lastSchedule
		local currentDamping: number? = spring._currentDamping
		local currentSpeed: number? = spring._currentSpeed

		if lastSchedule and currentDamping and currentSpeed then
			local posPos, posVel, velPos, velVel = springCoefficients(lastUpdateTime - lastSchedule, currentDamping, currentSpeed)
