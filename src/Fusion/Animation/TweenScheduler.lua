...
local function updateAllTweens()
	...
	for tween: Tween in pairs(allTweens :: any) do
		...
		local currentTweenInfo: TweenInfo? = tween._currentTweenInfo
		local currentTweenDuration: number? = tween._currentTweenDuration
		if currentTweenInfo and currentTweenDuration then
